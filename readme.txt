...
* Added support for Yoast SEO integration.
...
* Hide the certificate link for individual posts or pages.
...
* Fix for manual users, thanks Krijn!
* Many small enhancements

= 2.9.6 =
*Release date: January 21st, 2021*
* Performance optimisations
* Added an option to hide certificate links on individual post types

= 2.9.5 =
*Release date: January 13th, 2021*
* Bugfix for Woocommerce integration
* Add setting to hide the certificate from the homepage
* Add setting to hide the certificate from all pages
* Stability fixes

= 2.9.4 =
*Release date: January 13th, 2021*
* Raised the minimum PHP required
