      ...
      <div>
        {!this.state.hasAccount ?
          <div className="vo-card">
            ...
            <button type="button" className="button dismiss" onClick={this.closePopup}><span
              className="dashicons dashicons-no-alt"></span></button>
        ...
        <div className="vo-card">
          <div className="form-group">
            <label className="label" id="label_wordproof_network" htmlFor="wordproof_network">In what blockchain do you
              want to timestamp your content?</label>
