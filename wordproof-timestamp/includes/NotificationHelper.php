...
class NotificationHelper
{
  ...
  {
    $message = 'It looks like you started the WordProof Setup Wizard, but did not timestamp yet! Join our <a href="https://t.me/joinchat/DVuJAEfhf2QURBBjOWc2XA">Telegram group</a> for help, or send us an <a href="https://wordproof.io/contact">email</a>.';
    $type = 'info';
  ...
  {
    ob_start(); ?>
      <div class="notice wordproof-notice wordproof-notice--<?php echo $type; ?> <?php echo ($isDismissible) ? 'is-dismissible' : ''; ?>">
