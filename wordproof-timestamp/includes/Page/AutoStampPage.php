...
class AutoStampPage {
	...
	public function generateSettingsPage() {
		...
		<div class="wrap">
			...
			<p>Start auto-stamping <?php echo esc_html( sizeof( $posts ) ); ?> posts which are not timestamped yet. We
				will skip posts that are stamped already. <strong>Please make sure your setup works beforehand.</strong>
			</p>
			<p>Timestamp all of your posts cost <?php echo esc_html( sizeof( $posts ) ); ?> timestamps. If you don't
				have enough timestamps, you
				<a href="https://my.wordproof.io/sites/upgrade" target="_blank" rel="noopener noreferrer">can
