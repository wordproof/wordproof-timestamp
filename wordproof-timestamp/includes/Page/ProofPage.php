        ...
        if ($proof_date) {
          ...
          ?>
            ...
            <table>
                ...
                <tr>
                    <th>Post Content</th>
                    <td><textarea name="" id="" cols="100"
                                  rows="10"><?php echo esc_html($post->post_content) ?></textarea></td>
                </tr>
                <tr>
                    <th>Post Date</th>
                ...
                <tr>
                    ...
                    <td><a target="_blank"
                           href="<?php echo esc_html($transaction_url) ?>"><?php echo esc_html($transaction_url) ?></a>
                    </td>
                </tr>
            </table>
            <p>
                <small>WordProof Timestamp with WordProof.io, bringing WordPress to the blockchain.</small>
                <br>
                <small>Download the <a href="https://wordproof.io/timestamp-plugin/" target="_blank"
                                       rel="noopener noreferrer">WordProof Timestamp plugin</a> for free to timestamp
                    your WordPress content too.
                </small>
            </p>
