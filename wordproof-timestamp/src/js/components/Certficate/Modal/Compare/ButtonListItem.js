...
export default class ButtonListItem extends React.Component {
    ...
    render() {
        return (
            <a className={`text-darkblue font-semibold p-3 md:p-4 text-sm items-center w-1/2 md:w-1/4 justify-center ${(this.props.hideMobile ? 'hidden md:inline-flex' : 'inline-flex')}`} href={this.props.href}
