    ...
    return (
      <div className="vo-card">
        ...
        {!this.state.showTimestamp ?
            <div>
              <p>The WordProof Timestamp set-up consists of three steps and takes about 5 minutes. You only need to do
                this
              ...
              <p>Choose on which blockchain you want to timestamp your content. If you are not sure what this means,
                don’t
              ...
              {(() => {
                switch (this.state.network) {
                  ...
                  case 'telos_main':
                    return <p>Telos is the innovation district of the EOS.IO ecosystem. If you want to know more about
                      Telos,
                      read <a href="https://medium.com/goodblock-io/welcome-to-telos-wordproof-user-fd719b171341"
                              target="_blank" rel="noopener noreferrer">this introduction article by Telos founder
                        Douglas
                        Horn</a>.</p>
                  default:
                }
              ...
              <p>After making your choice, you are ready to set up WordProof! Click the button below to open our wizard,
                which
