...
export default class Manuel extends Component {
  constructor(props) {
    super(props)
    this.state = {
  ...
  render() {
    return (
      <div className="vo-card">
        <p>The WordProof Timestamp set-up consists of three steps and takes about 5 minutes. You only need to do this
          once using the Setup Wizard, which will guide you through the process!</p>
        <ol>
        ...
        <p>Choose on which blockchain you want to timestamp your content. If you are not sure what this means, don’t
          worry! We recommend to start on the Telos blockchain, since accounts are free.</p>

        <div className="form-group">
          <label htmlFor="wordproof_network_telos"
                 className={`radio-box ${ this.checkActiveRadio('telos_main') ? 'selected' : '' }`}>
            <input type="radio" id="wordproof_network_telos" name="wordproof_network" data-readable-name="Telos"
                   value="telos_main"
          ...
          <label htmlFor="wordproof_network_eos"
            ...
            <input type="radio" id="wordproof_network_eos" name="wordproof_network" data-readable-name="EOS"
                   value="eos_main"
          ...
          <label htmlFor="wordproof_network_jungle"
            ...
            <input type="radio" id="wordproof_network_jungle" name="wordproof_network" data-readable-name="EOS Jungle"
                   value="eos_jungle"
        ...
        {(() => {
          switch (this.state.network) {
            case 'eos_main':
              return <p>To use EOS, you need to buy an EOS account. The Wizard will walk you through the entire
                process.</p>;
            case 'eos_jungle':
              return <p>To use the EOS Jungle testnet, you should have your wallet setup already. Headover
                to &apos;Timestamp&apos; to test your connection.</p>;
            case 'telos_main':
              return <p>Telos is the innovation district of the EOS.IO ecosystem. If you want to know more about Telos,
                read <a href="https://medium.com/goodblock-io/welcome-to-telos-wordproof-user-fd719b171341"
                        target="_blank" rel="noopener noreferrer">this introduction article by Telos founder Douglas
                  Horn</a>.</p>
            default:
          }
        })()}

        <p>After making your choice, you are ready to set up WordProof! Click the button below to open our wizard, which
          will guide you through the rest of our process.</p>

        <button className="button is-primary"
                onClick={(e) => this.handleWindowPopup(e, 'https://wordproof.io/setup', this.state.network)}>Launch the
          Setup Wizard
        </button>
        <input type="submit" onClick={this.props.nextStep} name="submit" id="submit" className="button is-primary"
